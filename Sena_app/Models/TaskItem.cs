namespace Sena_app.Models
{
    ...
    // Enum de compatibilidad con el front — los valores coinciden con los nombres de las categorías globales del SEED en la BD.
    ...
    public class TaskItem
    {
        ...
        public TimeOnly? LimitHour { get; set; }
        ...
        /// DueDate — combina LimitDate y LimitHour para el front. El front lo usa para mostrar fechas y para asignar al editar.
